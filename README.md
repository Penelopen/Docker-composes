...
* **`Grafana/`** — Инструмент для мониторинга системы, БД и др. Работает в связке с Prometheus и Экспортерами метаданных.
* **`DataLens/`** — BI система (дашборды, метрики, графики).
